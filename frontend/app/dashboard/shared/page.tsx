      ...
      <nav className="bg-card border-b border-border p-4 sticky top-0 z-40 backdrop-blur-sm bg-card/95">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-semibold text-foreground">Shared Files</h1>
              <p className="text-sm text-muted-foreground">Files shared with you</p>
            </div>
          </div>
